...
with q1:
    ...
    st.write("correct") if a1 == "B) To plan how to spend money and manage income versus expenses" else st.write("Incorrect")
...
with q2:
    ...
    st.write("correct") if a2 == "C) Tracking income and expenses regularly" else st.write("Incorrect")
...
with q3:
    ...
    st.write("correct") if a3 == "B) To evaluate an individual's creditworthiness for loans and credit cards" else st.write("Incorrect")
...
with q4:
    ...
    st.write("correct") if a4 == "C) Paying bills on time and keeping credit utilization low" else st.write("Incorrect")
...
with q5:
    ...
    st.write("correct") if a5 == "B) To provide financial protection against unforeseen events like accidents or illness" else st.write("Incorrect")
...
with q6:
    ...
    st.write("correct") if a6 == "B) The amount you must pay out-of-pocket before insurance covers a claim" else st.write("Incorrect")
...
with q7:
    ...
    st.write("correct") if a7 == "B) To apply for federal student aid, including grants, loans, and work-study programs" else st.write("Incorrect")
...
with q8:
    ...
    st.write("correct") if a8 == "B) Grants and scholarships" else st.write("Incorrect")
...
with q9:
    ...
    st.write("correct") if a9 == "B) To earn returns over time and grow wealth" else st.write("Incorrect")
...
with q10:
    ...
    st.write("correct") if a9 == "B) Bonds" else st.write("Incorrect")
